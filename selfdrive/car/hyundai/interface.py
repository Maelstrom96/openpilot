...
from selfdrive.car.hyundai.carstate import CarState, get_can_parser, get_camera_parser, get_mdps_parser
...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), vin="", has_relay=False):
    ...
    if candidate in [CAR.SANTA_FE, CAR.SANTA_FE_1]:
      ...
      # ret.steerActuatorDelay = 0.100    # Default delay 0.100
      ret.lateralTuning.pid.kf = 0.00006
      ret.mass = 1490. + STD_CARGO_KG   # kg, per Hyundai site https://www.hyundaiusa.com/ioniq-electric/specifications.aspx
  ...
  def update(self, c, can_strings):
    ...
    self.CS.update(self.cp, self.cp_cam, self.cp_mdps)
    # create message
